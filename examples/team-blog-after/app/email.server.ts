...
// Lazy provider: defers env.get() to first send() call instead of module load time.
// This is required because Workers env isn't available until a request arrives.
