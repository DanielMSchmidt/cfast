...
import authorView from "../../../assets/tutorial/step-04-author-home.png";
import readerView from "../../../assets/tutorial/step-04-reader-home.png";
...
<Image src={authorView} alt="Home page as an author — New Post button is visible" />

A reader sees only published posts and no action buttons:

<Image src={readerView} alt="Home page as a reader — no New Post button, only published posts" />
