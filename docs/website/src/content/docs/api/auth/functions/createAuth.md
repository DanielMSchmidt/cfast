...
Defined in: [packages/auth/src/create-auth.ts:74](https://github.com/DanielMSchmidt/cfast/blob/411313cb52fffba4d319391ba8501eaf3ea7c30b/packages/auth/src/create-auth.ts#L74)
